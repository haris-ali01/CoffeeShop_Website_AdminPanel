...
?>
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-8 col-sm-12 text-center ftco-animate">
              ...
              <p><a href="#menu-items" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="<?php echo APPURL; ?>/menu.php" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
            </div>
    	...
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
        			...
        			// Display success or failure message based on the parameter
        			if ($_GET['success'] == 'true') {
            			echo '<div class="alert alert-success" role="alert">Booking successful!</div>';
        			} else {
            			echo '<div class="alert alert-danger" role="alert">Booking failed! Please try again.</div>';
        				}
    				}
    				?>
					...
					<?php if(isset($_SESSION['user_id'])) : ?>
		              <button type="submit" name="submit" class="btn btn-white py-3 px-4">Book</button>
					<?php else : ?> 
					  <button disabled type="submit" name="submit" class="btn btn-white py-3 px-4">Login to Book</button>
		            <?php endif; ?>
					</div>
	    				</div>
	    			</form>
    ...
    <section class="ftco-section">
    	<div class="container">
    		<div class="row align-items-center">
	            ...
	            <p><a href="<?php echo APPURL; ?>/menu.php" class="btn btn-primary btn-outline-primary px-4 py-3">View Full Menu</a></p>
	          </div>
    			</div>
    			<div class="col-md-6">
    				<div class="row">
    ...
    <section class="ftco-section" id="menu-items">
    	<div class="container">
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					...
    					<div class="text text-center pt-4">
    						<h3><a target="_blank" href="<?php echo APPURL; ?>/products/product-single.php?id=<?php echo $product->id; ?>"><?php echo $product->name; ?></a></h3>
    						<p><?php echo $product->description; ?></p>
    						<p class="price"><span>$<?php echo $product->price; ?></span></p>
    						<p><a href="products/product-single.php?id=<?php echo $product->id; ?>" class="btn btn-primary btn-outline-primary" target="_blank">Show</a></p>
    					</div>
    				</div>
        	</div>
        	<?php endforeach; ?>
	...
	<?php
				...
				foreach ($allReviews as $review):
					// Toggle between "testimony" and "testimony overlay" based on the counter
					$class = ($counter % 2 == 0) ? 'testimony' : 'testimony overlay';
					?>
					...
					<div class="col-md-3 align-self-sm-end ftco-animate">
						<div class="<?php echo $class; ?>">
							<blockquote>
								<p>&ldquo;
									<?php echo $review->review; ?>&rdquo;
								</p>
							</blockquote>
							<div class="author d-flex mt-4">
								<div class="image mr-3 align-self-center">
									<img src="<?php echo APPURL; ?>/images/person_2.jpg" alt="">
								</div>
